  ...
  return (
    <div className="sticky top-0 z-50 bg-secondary text-secondary-foreground">
      <div className="mx-auto max-w-6xl px-4 py-2 flex items-center justify-center gap-2 sm:gap-3 text-xs sm:text-sm">
        ...
        <span className="hidden sm:inline font-medium">Oferta expira em:</span>
        <span className="sm:hidden font-medium">Expira em:</span>
        <span className="font-mono font-bold tabular-nums bg-white/10 px-2 py-0.5 rounded">
